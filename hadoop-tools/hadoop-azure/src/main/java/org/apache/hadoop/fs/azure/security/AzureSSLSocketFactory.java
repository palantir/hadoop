...
public class AzureSSLSocketFactory extends SSLSocketFactory  {
    ...
    private static AzureSSLSocketFactory instance = null;
    private static final Logger LOG = LoggerFactory.getLogger(
            AzureSSLSocketFactory.class);
    ...
    public static synchronized void initializeDefaultFactory(
        ...
        if (instance == null) {
            instance = new AzureSSLSocketFactory(preferredMode);
        }
    }
     ...
     */
    public static AzureSSLSocketFactory getDefaultFactory() {
        return instance;
    }
    ...
    private AzureSSLSocketFactory(SSLChannelMode preferredChannelMode)
            throws IOException {
        try {
